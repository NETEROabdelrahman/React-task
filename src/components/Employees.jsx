        ...
        <div className="bg-[#f7f8f9] w-full h-[100vh] px-[35px]">
            <div className="w-full mt-3 pt-[29px] px-[48px] flex flex-row gap-2">
                <div className="w-[88%] p-0 relative">
                    ...
                    <AiOutlineSearch color='#23aaeb' className=' absolute top-[19%] left-8' />
                </div>
                <button className="bg-[#2764ac] text-white px-3 rounded w-[101px]" onClick={() => setIsModalOpen(true)}>+ add new</button>
            </div>
